...
/**
 * Renderer
 * Once you use the effectComposer, a lot of stuff below won't work
 * anymore, like antialias and outputEncoding. We need to solve that
 * with the renderTarget below.
 *
 */
...
/**
 * Post-processing
 * We have to decide which RenderTarget class to use based on 3
 * criteria (for fixing AA):
 *  - Users with pixel ratio above two won't need AA.
 *  - Users with pixel ratio below two and whose browser supports WebGl2.
 *  - Users with pixel ratio below two but whose browser does not support WebGL2.
 *
 * We'll sovler them like so (copied verbatim):
